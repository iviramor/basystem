...
namespace bas.program.Infrastructure.RealizationTables.Tables.Passive
{
    public class TBankPassiveCamp : ATable
    {
        ...
        public override void OnRemoveCommandExecute(object p)
        {
            ...
            {
                BankDbContext.Bank_passive_camp.Remove(Bank_data);
                BankDbContext.SaveChanges();
                MessageBox.Show($"{Bank_data.Pcamp_name} - Удалено");
                UpdateDataInTable();
                return;
            }
        }
        ...
        {
            BankPassiveCampViewModel clientViewModel = new(workSpaceWindowViewModel, "Добавить");
        ...
        public override void OnEditCommandExecute(object p)
        {
            ...
            BankPassiveCampViewModel clientViewModel = new(workSpaceWindowViewModel, Bank_data);
            clientViewModel.ShowWindow();
        }
        ...
        public override void OnShowCommandExecute(object p)
        {
            ...
            BankPassiveCampViewModel clientViewModel = new(Bank_data, workSpaceWindowViewModel.User.DataBase);
            clientViewModel.ShowWindow();
        }
        ...
        public override void SetSelected(DataRowView selectedItem)
        {
            ...
            Bank_data = BankDbContext.Bank_passive_camp
                .SingleOrDefault(item =>
                            item.Pcamp_name == (string)selectedItem[0] &&
                            item.Pcamp_quantity == decimal.Parse((string)selectedItem[1]));
        }
