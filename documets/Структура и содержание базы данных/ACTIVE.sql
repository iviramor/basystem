...
CREATE TABLE BANK_ACTIVE_ASSET
(
	ass_id INT PRIMARY KEY IDENTITY(1, 1),
	ass_name NVARCHAR(250) NOT NULL,
	ass_cash DECIMAL(10,2) NOT NULL,
	ass_type INT FOREIGN KEY REFERENCES BANK_CURRENCY(currency_id) NOT NULL
);

CREATE TABLE BANK_ACTIVE_DEBIT
(
